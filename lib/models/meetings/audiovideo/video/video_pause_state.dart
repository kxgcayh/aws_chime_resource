...
extension ListVideoPauseStateExtension on List<VideoPauseState> {
  VideoPauseState fromValue(int code) {
    for (var videoPause in this) {
      if (videoPause.value == code) return videoPause;
    }
    return VideoPauseState.unpaused;
  }
}
