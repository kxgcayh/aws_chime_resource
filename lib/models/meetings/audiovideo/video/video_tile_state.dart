...
import 'package:aws_chime_resource/models/meetings/audiovideo/video/video_pause_state.dart';
...
class VideoTileState {
  ...
  factory VideoTileState.fromMap(Map<String, dynamic> map) {
    return VideoTileState(
      ...
      videoPauseState: VideoPauseState.values.fromValue(map['pauseState']),
    );
  }
