...
extension MeetingSessionStatusCodeExtension on MeetingSessionStatusCode {
  ...
  MeetingSessionStatusCode from(int intValue) {
...
extension ListMeetingSessionStatusCodeExtension
    on List<MeetingSessionStatusCode> {
  MeetingSessionStatusCode fromValue(int code) {
